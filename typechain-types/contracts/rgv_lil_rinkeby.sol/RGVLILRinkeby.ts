...
export interface RGVLILRinkebyInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "reveal", values: [boolean]): string;
...
export interface RGVLILRinkeby extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RGVLILRinkebyInterface;
  ...
  callStatic: {
    ...
    reveal(_state: boolean, overrides?: CallOverrides): Promise<void>;
